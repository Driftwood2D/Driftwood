...
def focus():
    ...
    Driftwood.script.call("stdlib/light.py", "flicker", a.lid, 0, 0, 10, 8)
    Driftwood.script.call("stdlib/light.py", "flicker", b.lid, 0, 0, 10, 8)
    Driftwood.script.call("stdlib/light.py", "flicker", c.lid, 0, 0, 10, 8)
